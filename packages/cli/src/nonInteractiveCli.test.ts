...
import { Config, GeminiClient, ToolRegistry } from '@whisper-ai/whisper-cli-core';
import { GenerateContentResponse, Part, FunctionCall } from '@google/genai';

// Mock dependencies
vi.mock('@whisper-ai/whisper-cli-core', async () => {
  const actualCore = await vi.importActual<
    typeof import('@whisper-ai/whisper-cli-core')
  >('@whisper-ai/whisper-cli-core');
  return {
    ...actualCore,
    GeminiClient: vi.fn(),
    ToolRegistry: vi.fn(),
