...
import {
  ...
  SandboxConfig,
} from '@whisper-ai/whisper-cli-core';
...
vi.mock('@whisper-ai/whisper-cli-core', async (importOriginal) => {
  const actualCore =
    await importOriginal<typeof import('@whisper-ai/whisper-cli-core')>();
